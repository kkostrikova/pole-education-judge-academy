...
{no:50,type:'single',text:'Я — гарний суддя, постійно розвиваюся, навчаюся та вдосконалюю свої професійні навички.',options:['Погоджуюсь'],noScore:true,note:'Фінальне підтвердження. Це питання обов’язкове, але не впливає на екзаменаційний бал.'}
];
