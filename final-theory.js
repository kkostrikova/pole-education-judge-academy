...
{no:28,type:'text',text:'Скільки штрафів ви бачите на картинці? Якщо є — які і чому; якщо немає — вкажіть 0.',media:media('Зображення до питання про штрафи','image','https://cdn.creativeclaw.co/u/931444b3/images/fde363f4-697f-4489-8fba-50276a5c7bb5.png'),note:'Відкрита відповідь.'},
{no:29,type:'single',text:'Скільки штрафів ви бачите на картинці?',options:['Заднє коліно','Обидва коліна','Неправильний ракурс','Варіант 1, 2','Варіант 1, 3','Варіант 2, 3'],media:media('Зображення до питання 29','image','https://cdn.creativeclaw.co/u/931444b3/images/238b643e-7baa-475a-8d3d-036fe3b65294.png')},
{no:30,type:'single',text:'Чи зарахує суддя з артистизму махове колесо, якщо після нього була незначна втрата балансу?',options:['Так, зарахує','Не зарахує','Оцінить елемент, але з незначним зниженням балів.']},
{no:31,type:'text',text:'В чому відмінність зриву від розмоту (полотна)?',note:'Відкрита відповідь.'},
{no:32,type:'single',text:'Чи потрібно ставити тут штраф за скорочення верхньої стопи?',options:['Так, потрібно','Ні, така стопа допускається'],media:media('Зображення до питання про верхню стопу','image','https://cdn.creativeclaw.co/u/931444b3/images/a706a849-898a-41f5-80b4-454ff008b34d.png')},
{no:33,type:'single',text:'Скільки збавок за лінії ви поставите спортсмену?',options:['Скоріше 1','Скоріше 2','Скоріше 3'],media:media('Зображення до оцінювання ліній','image','https://cdn.creativeclaw.co/u/931444b3/images/bc74427d-e2da-406a-b0da-2643d062821f.png')},
{no:34,type:'single',text:'Під час виконання акробатичного елементу спортсмен впав. Як ви оціните це в бланку «Артистизм і хореографія»?',options:['Елемент буде зарахований зі зниженням','0, елемент не буде зарахованим взагалі.']},
{no:35,type:'single',text:'У спортсмена костюм з надмірним оголенням сідниць, а під час виступу відпав елемент костюму. Як ми оцінимо це в бланку штрафів Pole Education?',options:['Поставимо збавку -5','Поставимо дві збавки по -5 за кожен випадок, в сумі 10 балів.']},
{no:36,type:'single',text:'У дорослого спортсмена під час виступу пішла носом кров. Як повинен вчинити головний суддя?',options:['Негайно зупинити виступ','Почекати 30 секунд, можливо все владнається','Нічого не робити, дорослий сам повинен вирішувати, продовжувати чи ні.']},
{no:37,type:'single',text:'Спортсмен під час виступу поправив зачіску, потім поправив на сідницях костюм. Скільки штрафів ми поставимо?',options:['Знімемо штраф разово, за проблеми з костюмом.','Буде 2 збавки, за кожен раз.']},
{no:38,type:'single',text:'Чи є доречним виконання елементу «колиска» в дитячих категоріях?',options:['Ні, недоречний, і має бути оштрафований у пункті «Відверті рухи та позиції»','Доречний і допустимий у правильних ракурсах.','Будь-яка позиція з розведеними ногами не допускається в дитячих категоріях.']},
{no:39,type:'single',text:'Чи обов’язковою є наявність спідньої білизни під костюмом?',options:['Так, обов’язково мати спідню білизну.','Наявність спідньої білизни обов’язкова тільки в дорослих категоріях.','Це на розсуд спортсмена.']},
{no:40,type:'single',text:'Чи ставимо ми збавку за ракурс, якщо спортсмен виконував елемент на динамічному предметі, витримав 2 секунди, але не докрутив до демонстрації загальноприйнятих ліній?',options:['Так, ми ставимо збавку за ракурс.','Ні, на динамічному предметі ми не ставимо збавку за ракурс. Тільки на статиці.']},
{no:41,type:'single',text:'Чи можемо ми поставити максимальний бал в оцінці заповнення сцени, якщо сама сцена була заповнена максимально, але пілони використані лише на 70%?',options:['Ми поставимо оцінку 5.','4, бо потрібно вилазити до самого верху для максимальної оцінки.']},
{no:42,type:'single',text:'На статичному пілоні спортсмен провів приблизно хвилину, на динамічному — рівно стільки ж, але доліз тільки до середини. Чи вплине це на оцінку «Баланс трюків на предметі» в протоколі арт і хорео?',options:['Ні, не вплине, баланс можна показати без заповнення усієї висоти динаміки','Так, суттєво вплине, ми точно знизимо бал.']},
{no:43,type:'single',text:'На попередніх трьох змаганнях спортсмен допускав багато значних похибок, включно з падінням. На поточних змаганнях цих похибок не було. Як ми оцінимо рівень спортсмена?',options:['Знизимо оцінку, бо ми знаємо, який насправді в нього рівень, йому просто пощастило.','Будемо покладатися тільки на результат поточного виступу.']},
{no:44,type:'single',text:'Під час виступу ви опустили очі у протокол, а підвівши погляд побачили, що спортсмен неначе похитнувся. Ви не впевнені, що це була втрата балансу. Що ви зробите?',options:['Перше враження правильне, поставлю збавку за баланс','Я не ставитиму збавку, навіть якщо вона була: при сумнівах судді перевага завжди надається спортсмену.']},
{no:45,type:'single',text:'Чи допускається такий костюм у категорії Pole Sport?',options:['Так, якщо крила не заважають виступу','Ні, реквізит та подібні костюми не допускаються в Pole Sport','Крила можна, а за хвіст буде збавка.'],media:media('Зображення костюму до питання 45','image','https://cdn.creativeclaw.co/u/931444b3/images/505901e4-54f5-4e4d-869d-975c3ef6e175.png')},
{no:46,type:'single',text:'Чи будемо ми нижче оцінювати спортсмена, якщо у нього є зайва вага?',options:['Так, це не естетично, і ми обов’язково знижуватимемо бал.','Будемо знижувати тільки тоді, якщо це дуже надмірно.','Ні, вага спортсмена не впливатиме на нашу оцінку.']},
{no:47,type:'text',text:'Оцініть костюм як суддя по штрафах. За що тут можна отримати збавку?',media:media('Зображення костюму до відкритого питання','image','https://cdn.creativeclaw.co/u/931444b3/images/d8c275d1-cf87-4385-ae63-bcce0bb90a52.png'),note:'Відкрита відповідь.'},
{no:48,type:'single',text:'Чи бере до уваги суддя з «Артистизму і хореографії» складність елементів, оцінюючи критерій «Баланс трюків на предметі»?',options:['Так, чим складніші трюки, тим буде більша оцінка','Ні, в цьому критерії оцінюється рівноцінність виконання різних груп елементів, без надання переваги одній групі.']},
{no:49,type:'single',text:'Учасник закінчив свій виступ до закінчення музики і зробив уклін якраз в останні ноти. Як ми це оцінимо?',options:['Знімемо бал за відсутність логічного кінця.','Не будемо знімати бал, адже уклін допускається, коли лунає музика. Головне — закінчити в останню ноту.']},
